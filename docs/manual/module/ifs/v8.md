...
--------------------------
### serialize
**将值序列化为 [Buffer](../../object/ifs/Buffer.md)**

```JavaScript
static Buffer v8.serialize(Value value);
```
...
返回结果:
* [Buffer](../../object/ifs/Buffer.md), 返回序列化后的 [Buffer](../../object/ifs/Buffer.md)
...
--------------------------
### deserialize
**将 [Buffer](../../object/ifs/Buffer.md) 反序列化为值**

```JavaScript
static Value v8.deserialize(Buffer data);
```

调用参数:
* data: [Buffer](../../object/ifs/Buffer.md), 要反序列化的 [Buffer](../../object/ifs/Buffer.md)
