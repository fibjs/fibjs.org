...
digraph {
    ...
    HttpResponse [tooltip="HttpResponse", fillcolor="lightgray", id="me", label="{HttpResponse|new HttpResponse()\l|statusCode\lstatusMessage\lstatus\lok\lcookies\l|writeHead()\laddCookie()\lredirect()\l}"];
