# 对象 Inflate
Inflate 解压缩编解码器，解压 deflate 算法压缩的数据([zlib](../../module/ifs/zlib.md)格式)
...
digraph {
    ...
    Inflate [tooltip="Inflate", fillcolor="lightgray", id="me", label="{Inflate|new Inflate()\l}"];
...
```JavaScript
Buffer Inflate._processChunk(Buffer chunk,
    Integer flushFlag);
```
