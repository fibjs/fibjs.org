...
```JavaScript
readonly XmlElement XmlComment.parentElement;
```
...
```JavaScript
readonly Boolean XmlComment.isConnected;
```
...
```JavaScript
Boolean XmlComment.contains(XmlNode node);
```
...
```JavaScript
XmlNode XmlComment.getRootNode();
```
...
```JavaScript
Integer XmlComment.compareDocumentPosition(XmlNode other);
```
...
```JavaScript
Boolean XmlComment.isEqualNode(XmlNode other);
```
...
```JavaScript
Boolean XmlComment.isSameNode(XmlNode other);
```
