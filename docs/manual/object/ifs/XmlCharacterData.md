...
```JavaScript
readonly XmlElement XmlCharacterData.parentElement;
```
...
```JavaScript
readonly Boolean XmlCharacterData.isConnected;
```
...
```JavaScript
XmlNode XmlCharacterData.remove();
```
...
```JavaScript
XmlCharacterData.replaceWith(...nodes);
```
...
```JavaScript
Boolean XmlCharacterData.contains(XmlNode node);
```
...
```JavaScript
XmlNode XmlCharacterData.getRootNode();
```
...
```JavaScript
Integer XmlCharacterData.compareDocumentPosition(XmlNode other);
```
...
```JavaScript
Boolean XmlCharacterData.isEqualNode(XmlNode other);
```
...
```JavaScript
Boolean XmlCharacterData.isSameNode(XmlNode other);
```
