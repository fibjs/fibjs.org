...
```JavaScript
readonly XmlElement XmlDocumentType.parentElement;
```
...
```JavaScript
readonly Boolean XmlDocumentType.isConnected;
```
...
```JavaScript
XmlNode XmlDocumentType.remove();
```
...
```JavaScript
XmlDocumentType.replaceWith(...nodes);
```
...
```JavaScript
Boolean XmlDocumentType.contains(XmlNode node);
```
...
```JavaScript
XmlNode XmlDocumentType.getRootNode();
```
...
```JavaScript
Integer XmlDocumentType.compareDocumentPosition(XmlNode other);
```
...
```JavaScript
Boolean XmlDocumentType.isEqualNode(XmlNode other);
```
...
```JavaScript
Boolean XmlDocumentType.isSameNode(XmlNode other);
```
