...
```JavaScript
static Object MemoryStream.addAbortListener(EventEmitter signal,
    Function func);
```
...
```JavaScript
static Object MemoryStream.once(EventEmitter emitter,
    Value ev,
    Object options = {});
```
...
```JavaScript
static Object MemoryStream.on(EventEmitter emitter,
    Value ev,
    Object options = {});
```
...
```JavaScript
static Integer MemoryStream.defaultMaxListeners;
```
...
```JavaScript
readonly Boolean MemoryStream.writable;
```
...
```JavaScript
readonly Boolean MemoryStream.readable;
```
...
```JavaScript
readonly Object MemoryStream._readableState;
```
...
```JavaScript
readonly Object MemoryStream._writableState;
```
...
```JavaScript
Variant MemoryStream.read(Integer bytes = -1) async;
```
...
```JavaScript
Buffer MemoryStream.readBuffer(Integer bytes = -1) async;
```
...
```JavaScript
Stream MemoryStream.setEncoding(String encoding);
```
...
```JavaScript
MemoryStream.writeBuffer(Buffer data) async;
```
...
```JavaScript
Boolean MemoryStream.write(Buffer data) async;
```
...
```JavaScript
Boolean MemoryStream.write(Buffer data,
...
```JavaScript
Boolean MemoryStream.write(String data,
...
```JavaScript
Value MemoryStream.pipe(Value destination,
    Object options = {});
```
...
```JavaScript
MemoryStream.unpipe(Stream destination = NULL);
```
...
```JavaScript
Integer MemoryStream.end() async;
```
...
```JavaScript
Integer MemoryStream.end(Buffer data) async;
```
...
```JavaScript
Integer MemoryStream.end(Buffer data,
    String encoding) async;
```
...
```JavaScript
Integer MemoryStream.end(String data,
    String encoding = "utf8") async;
```
...
```JavaScript
StreamReader MemoryStream.getReader();
```
...
```JavaScript
Stream MemoryStream.destroy(Value err = undefined) async;
```
...
```JavaScript
Object MemoryStream.on(Value ev,
    Function func);
```
...
```JavaScript
Object MemoryStream.on(Object map);
```
...
```JavaScript
Object MemoryStream.addListener(Value ev,
    Function func);
```
...
```JavaScript
Object MemoryStream.addListener(Object map);
```
...
```JavaScript
Object MemoryStream.addEventListener(Value ev,
    Function func,
    Object options = {});
```
...
```JavaScript
Object MemoryStream.prependListener(Value ev,
    Function func);
```
...
```JavaScript
Object MemoryStream.prependListener(Object map);
```
...
```JavaScript
Object MemoryStream.once(Value ev,
    Function func);
```
...
```JavaScript
Object MemoryStream.once(Object map);
```
...
```JavaScript
Object MemoryStream.prependOnceListener(Value ev,
    Function func);
```
...
```JavaScript
Object MemoryStream.prependOnceListener(Object map);
```
...
```JavaScript
Object MemoryStream.off(Value ev,
    Function func);
```
...
```JavaScript
Object MemoryStream.off(Object map);
```
...
```JavaScript
Object MemoryStream.removeListener(Value ev,
    Function func);
```
...
```JavaScript
Object MemoryStream.removeListener(Object map);
```
...
```JavaScript
Object MemoryStream.removeEventListener(Value ev,
    Function func,
    Object options = {});
```
...
```JavaScript
Object MemoryStream.removeAllListeners(Value ev);
```
...
```JavaScript
Object MemoryStream.removeAllListeners(Array evs = []);
```
...
```JavaScript
MemoryStream.setMaxListeners(Integer n);
```
...
```JavaScript
Integer MemoryStream.getMaxListeners();
```
...
```JavaScript
Array MemoryStream.listeners(Value ev);
```
...
```JavaScript
Array MemoryStream.rawListeners(Value ev);
```
...
```JavaScript
Integer MemoryStream.listenerCount(Value ev);
```
...
```JavaScript
Integer MemoryStream.listenerCount(Value o,
    Value ev);
```
...
```JavaScript
Boolean MemoryStream.emit(Value ev,
    ...args);
```
...
```JavaScript
event MemoryStream.data(Buffer data);
```
...
```JavaScript
event MemoryStream.error(Integer code);
```
