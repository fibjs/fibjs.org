...
digraph {
    ...
    TTYInputStream [tooltip="TTYInputStream", fillcolor="lightgray", id="me", label="{TTYInputStream|new TTYInputStream()\l|isTTY\lreadable\lisRaw\l|setRawMode()\l}"];
...
### TTYInputStream
**创建一个新的 TTYInputStream 对象, 参数 fd 指定底层的文件描述符**

```JavaScript
new TTYInputStream(Integer fd,
    Object opts = {});
```
...
--------------------------
**创建一个新的 TTYInputStream 对象, 参数 fd 指定底层的文件对象**

```JavaScript
new TTYInputStream(FileHandle fd,
    Object opts = {});
```
...
```JavaScript
static Object TTYInputStream.addAbortListener(EventEmitter signal,
    Function func);
```
...
```JavaScript
static Object TTYInputStream.once(EventEmitter emitter,
    Value ev,
    Object options = {});
```
...
```JavaScript
static Object TTYInputStream.on(EventEmitter emitter,
    Value ev,
    Object options = {});
```
...
```JavaScript
static Integer TTYInputStream.defaultMaxListeners;
```
...
--------------------------
### readable
**Boolean, 恒为 true，表示流可读**

```JavaScript
readonly Boolean TTYInputStream.readable;
```
...
```JavaScript
readonly Boolean TTYInputStream.writable;
```
...
```JavaScript
readonly Object TTYInputStream._readableState;
```
...
```JavaScript
readonly Object TTYInputStream._writableState;
```
...
```JavaScript
Variant TTYInputStream.read(Integer bytes = -1) async;
```
...
```JavaScript
Buffer TTYInputStream.readBuffer(Integer bytes = -1) async;
```
...
```JavaScript
Buffer TTYInputStream.readAll() async;
```
...
```JavaScript
Stream TTYInputStream.setEncoding(String encoding);
```
...
```JavaScript
TTYInputStream.writeBuffer(Buffer data) async;
```
...
```JavaScript
Boolean TTYInputStream.write(Buffer data) async;
```
...
```JavaScript
Boolean TTYInputStream.write(Buffer data,
...
```JavaScript
Boolean TTYInputStream.write(String data,
...
```JavaScript
Value TTYInputStream.pipe(Value destination,
    Object options = {});
```
...
```JavaScript
TTYInputStream.unpipe(Stream destination = NULL);
```
...
```JavaScript
Integer TTYInputStream.end() async;
```
...
```JavaScript
Integer TTYInputStream.end(Buffer data) async;
```
...
```JavaScript
Integer TTYInputStream.end(Buffer data,
    String encoding) async;
```
...
```JavaScript
Integer TTYInputStream.end(String data,
    String encoding = "utf8") async;
```
...
```JavaScript
StreamReader TTYInputStream.getReader();
```
...
```JavaScript
Stream TTYInputStream.destroy(Value err = undefined) async;
```
...
```JavaScript
Object TTYInputStream.on(Value ev,
    Function func);
```
...
```JavaScript
Object TTYInputStream.on(Object map);
```
...
```JavaScript
Object TTYInputStream.addListener(Value ev,
    Function func);
```
...
```JavaScript
Object TTYInputStream.addListener(Object map);
```
...
```JavaScript
Object TTYInputStream.addEventListener(Value ev,
    Function func,
    Object options = {});
```
...
```JavaScript
Object TTYInputStream.prependListener(Value ev,
    Function func);
```
...
```JavaScript
Object TTYInputStream.prependListener(Object map);
```
...
```JavaScript
Object TTYInputStream.once(Value ev,
    Function func);
```
...
```JavaScript
Object TTYInputStream.once(Object map);
```
...
```JavaScript
Object TTYInputStream.prependOnceListener(Value ev,
    Function func);
```
...
```JavaScript
Object TTYInputStream.prependOnceListener(Object map);
```
...
```JavaScript
Object TTYInputStream.off(Value ev,
    Function func);
```
...
```JavaScript
Object TTYInputStream.off(Object map);
```
...
```JavaScript
Object TTYInputStream.removeListener(Value ev,
    Function func);
```
...
```JavaScript
Object TTYInputStream.removeListener(Object map);
```
...
```JavaScript
Object TTYInputStream.removeEventListener(Value ev,
    Function func,
    Object options = {});
```
...
```JavaScript
Object TTYInputStream.removeAllListeners(Value ev);
```
...
```JavaScript
Object TTYInputStream.removeAllListeners(Array evs = []);
```
...
```JavaScript
TTYInputStream.setMaxListeners(Integer n);
```
...
```JavaScript
Integer TTYInputStream.getMaxListeners();
```
...
```JavaScript
Array TTYInputStream.listeners(Value ev);
```
...
```JavaScript
Array TTYInputStream.rawListeners(Value ev);
```
...
```JavaScript
Integer TTYInputStream.listenerCount(Value ev);
```
...
```JavaScript
Integer TTYInputStream.listenerCount(Value o,
    Value ev);
```
...
```JavaScript
Array TTYInputStream.eventNames();
```
...
```JavaScript
Boolean TTYInputStream.emit(Value ev,
    ...args);
```
...
```JavaScript
event TTYInputStream.data(Buffer data);
```
...
```JavaScript
event TTYInputStream.error(Integer code);
```
